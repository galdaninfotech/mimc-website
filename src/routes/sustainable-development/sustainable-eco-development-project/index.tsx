                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Sustainable Eco-development Project</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Sustainable Development</a><span class="delimiter">&gt;</span>
                                    <span class="current">Sustainable Eco-development Project</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
export const head: DocumentHead = {
  title: 'Sustainable Eco-development Project',
  meta: [
    {
      name: 'description',
      content: 'Sustainable Eco-development Project',
    },
  ],
};