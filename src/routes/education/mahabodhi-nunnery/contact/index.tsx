                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Contact Nunnery</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Education</a><span class="delimiter">&gt;</span>
                                    <a href="/">Mahabodhi Nunnery</a><span class="delimiter">&gt;</span>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">CONTACT NUNNERY</h3>
                                    <form id="contact-form" method="post" action="">
                                        ...
                                        <input class="qbutton with_shadow qode-contact-page-button" type="submit" value="CONTACT Nunnery" />
                                        </span>
                                    </form>
                                </div>
                            </div>
...
export const head: DocumentHead = {
  title: 'Contact Nunnery',
  meta: [
    {
      name: 'description',
      content: 'Contact Nunnery',
    },
  ],
};