                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Contact Boy's Hostel</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    ...
                                    <span class="current">Contact Boy's Hostel</span>
                                </div>
                            </div>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">CONTACT BOY'S HOSTEL</h3>
                                    <form id="contact-form" method="post" action="">
                                        ...
                                        <input class="qbutton with_shadow qode-contact-page-button" type="submit" value="CONTACT Boy's Hostel" />
                                        </span>
                                    </form>
                                </div>
                            </div>
...
export const head: DocumentHead = {
  title: 'Contact Boys Hostel',
  meta: [
    {
      name: 'description',
      content: 'Contact Boys Hostel',
    },
  ],
};