                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Mahabodhi Educational Program</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Education</a><span class="delimiter">&gt;</span>
                                    <span class="current">Mahabodhi Educational Program</span>
                                </div>
                            </div>
...
export const head: DocumentHead = {
  title: 'Mahabodhi Educational Program',
  meta: [
    {
      name: 'description',
      content: 'Mahabodhi Educational Program',
    },
  ],
};