                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Meditation and yoga schedule</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs"><a href="/">Home</a><span class="delimiter">&gt;</span><span class="current">Meditation and yoga schedule</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <p>For more info, Plz contact:</p>
                                                            <div>Email: infomimc@gmail.com</div>
                                                            <div>Phone: +91-1982-264372, +91-1126-181109, +91-9906982025</div>
...
export const head: DocumentHead = {
  title: 'Meditation and yoga schedule',
  meta: [
    {
      name: 'description',
      content: 'Meditation and yoga schedule',
    },
  ],
};