                        ...
                        <div class="container_inner clearfix" style="padding: 0;">
                            ...
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    ...
                                    <span class="delimiter">&gt;</span><span class="current">Notice</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">ONLINE REGISTRATION</h3>
                                    <form id="contact-form" method="post" action="">
                                        ...
                                        <input class="qbutton with_shadow qode-contact-page-button" type="submit" value="Online Registration" />
                                        </span>
                                    </form>
                                </div>
                            </div>
