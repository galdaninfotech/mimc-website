                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Sambodhi Retreat Centre</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a>
                                    <span class="delimiter">&gt;</span><span class="current">Meditation</span>
                                    <span class="delimiter">&gt;</span><span class="current">Sambodhi Retreat Centre</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/about/our-motto.jpg" alt="Sambodhi Retreat Centre" />
                                                            </div>
...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: 'description',
      content: 'Sambodhi Retreat Centre',
    },
  ],
};