                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Visually Impaired Hostel</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Social Welfare</a><span class="delimiter">&gt;</span>
                                    <span class="current">Visually Impaired Hostel</span>
                                </div>
                            </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/social-welfare/visually-impaired-hostel.jpg" alt="Visually Impaired Hostel" />
                                                            </div>
...
export const head: DocumentHead = {
  title: 'Visually Impaired Hostel',
  meta: [
    {
      name: 'description',
      content: 'Visually Impaired Hostel',
    },
  ],
};