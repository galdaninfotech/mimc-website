                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Contact Karuna Charitable Hospital</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Social Welfare</a><span class="delimiter">&gt;</span>
                                    <a href="/">Karuna Charitable Hostel</a><span class="delimiter">&gt;</span>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">CONTACT KARUNA CHARITABLE HOSPITAL</h3>
...
export const head: DocumentHead = {
  title: 'Contact Karuna Charitable Hospital',
  meta: [
    {
      name: 'description',
      content: 'Contact Karuna Charitable Hospital',
    },
  ],
};