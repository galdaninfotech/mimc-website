                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Contact Old Age Home</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Social Welfare</a><span class="delimiter">&gt;</span>
                                    <a href="/">Old Age Home</a><span class="delimiter">&gt;</span>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">CONTACT OLD AGE HOME</h3>
...
export const head: DocumentHead = {
  title: 'Contact Old Age Home',
  meta: [
    {
      name: 'description',
      content: 'Contact Old Age Home',
    },
  ],
};