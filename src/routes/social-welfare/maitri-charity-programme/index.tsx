                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Maitri Charity Programme</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a><span class="delimiter">&gt;</span>
                                    <a href="/">Social Welfare</a><span class="delimiter">&gt;</span>
                                    <span class="current">Maitri Charity Programme</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/about/our-motto.jpg" alt="Maitri Charity Programme" />
                                                            </div>
...
export const head: DocumentHead = {
  title: 'Maitri Charity Programme',
  meta: [
    {
      name: 'description',
      content: 'Maitri Charity Programme',
    },
  ],
};