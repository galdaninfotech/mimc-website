                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/about/our-motto.jpg" alt="Inter Faith Programe" />
                                                            </div>
...
export const head: DocumentHead = {
  title: 'Inter Faith Programe',
  meta: [
    {
      name: 'description',
      content: 'Inter Faith Programe',
    },
  ],
};