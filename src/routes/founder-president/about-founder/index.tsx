                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">About The Founder</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs">
                                    <a href="/">Home</a>
                                    <span class="delimiter">&gt;</span><span class="current">Founder President</span>
                                    <span class="delimiter">&gt;</span><span class="current">The Founder</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/founder-president/about-founder.jpg" alt="About The Founder" />
                                                            </div>
                                                            ...
                                                            <p>
                                                                In 1986, <strong>Venerable Bhikkhu Sanghasena</strong>, returned to Ladakh and founded the <strong>Mahabodhi International Meditation Centre</strong> (MIMC) in Ladakh which is the first and only Theravada Buddhist monastery and institution in the entire western Himalayas. Since then he has worked tirelessly and selflessly to put the Buddha's teachings of loving kindness and compassion into action through multifarious charitable humanitarian services which are being carried out from moon- like desert sprawled over 250 acres that forms the impressive backdrop to the Devachan Campus at Choglamsar, Ladakh. 
                                                            </p>
                                                            <p>&nbsp;</p>
                                                            ...
                                                            <div class="list number">
                                                                <ul>
                                                                    <li>High quality education and safe shelter for underprivileged children</li>
                                                                    <li>Compassionate healthcare for the sick and the needy</li>
                                                                    <li>Empowerment and literacy programmes for women and other socially disadvantaged groups</li>
                                                                    <li>A caring home for the aged and destitute, and many other humanitarian services</li>
                                                                    <li>And many other humanitarian services</li>
                                                                </ul>
                                                            </div>
                                                            <p>
