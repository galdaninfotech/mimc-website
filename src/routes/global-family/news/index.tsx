                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Global Family News</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs"><a href="/">Home</a><span class="delimiter">&gt;</span><span class="current">Global Family News</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div class="wpb_text_column wpb_content_element ">
                                                        <div class="wpb_wrapper" style="color: #6c6c6c;">
                                                            ...
                                                            <div class="image_with_text_over" style="margin-bottom: 50px;">
                                                                ...
                                                                <img src="/images/about/our-motto.jpg" alt="Global Family News" />
                                                            </div>
...
export const head: DocumentHead = {
  title: 'Global Family News',
  meta: [
    {
      name: 'description',
      content: 'Global Family News',
    },
  ],
};