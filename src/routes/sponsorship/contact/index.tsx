                ...
                <div class="title_holder" style="opacity: 1;">
                    <div class="container">
                        <div class="container_inner clearfix" style="padding: 0;">
                            <h1 style="padding: 0; margin: 0;">Contact For Sponsorship</h1>
                            <div class="breadcrumb">
                                <div class="breadcrumbs"><a href="https://mahabodhi=ladakh.com/subway/">Home</a><span class="delimiter">&gt;</span><span class="current">Contact For Sponsorship</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="column1">
                            <div class="column_inner">
                                <div class="contact_form">
                                    <h3 style="color: #000; font-size: 18px;">CONTACT FORSPONSORSHIP</h3>
                                    <form id="contact-form" method="post" action="">
                                        ...
                                        <input class="qbutton with_shadow qode-contact-page-button" type="submit" value="CONTACT Karuna Charitable Hospital" />
                                        </span>
                                    </form>
                                </div>
                            </div>
...
export const head: DocumentHead = {
  title: 'Contact For Sponsorship',
  meta: [
    {
      name: 'description',
      content: 'Contact For Sponsorship',
    },
  ],
};