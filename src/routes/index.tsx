                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        ...
                                                        <span class="custom_font_holder" style=" font-size: 35px; line-height: 37px; font-style: normal; font-weight: 400; color: #000000; text-decoration: none; text-align: center;">&nbsp;<span style="color: darkred;">SERVICES</span> WE OFFER</span>
                                                        <div class="separator transparent" style="margin-top:7px;margin-bottom:8px;"></div>
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                <p style="text-align: center; color:black;">MIMC is dedicated for the service of the people. Listed below are a few services that MIMC offer to the local people.</p>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="vc_column-inner">
                                                                    <div class="wpb_wrapper">
                                                                        <div class="box_image_with_border" style="color:black;">
                                                                            ...
                                                                            <h3 style="color:black; font-size: 18px; text-transform: uppercase">Sambodhi Retreat Centre</h3>
                                                                ...
                                                                <div class="vc_column-inner">
                                                                    <div class="wpb_wrapper">
                                                                        <div class="box_image_with_border" style="color:black;">
                                                                            ...
                                                                            <h3 style="color:black; font-size: 18px; text-transform: uppercase">Mahabodhi Residential School</h3>
                                                                ...
                                                                <div class="vc_column-inner">
                                                                    <div class="wpb_wrapper">
                                                                        <div class="box_image_with_border" style="color:black;">
                                                                            ...
                                                                            <h3 style="color:black; font-size: 18px; text-transform: uppercase">Karuna Charitable Hospital</h3>
                                                                ...
                                                                <div class="vc_column-inner">
                                                                    <div class="wpb_wrapper">
                                                                        <div class="box_image_with_border" style="color:black;">
                                                                            ...
                                                                            <h3 style="color:black; font-size: 18px; text-transform: uppercase">Visually Impaired Hostel</h3>
